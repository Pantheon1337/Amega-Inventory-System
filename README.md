# 🏢 Invent Beta v1.0 - Система учета оборудования

Современная веб-система для управления инвентаризацией IT-оборудования с интерактивным визуальным планировщиком помещений.
